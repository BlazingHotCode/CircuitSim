...
public class Wire {
    ...
    private boolean logicPowered = false;
    ...
    /**
     * @return true when the wire is driven by a logic signal
     */
    public boolean isLogicPowered() {
        return logicPowered;
    }

    /**
     * Marks whether the wire is driven by a logic signal.
     */
    public void setLogicPowered(boolean logicPowered) {
        this.logicPowered = logicPowered;
    }
