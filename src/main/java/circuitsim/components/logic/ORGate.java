...
public class ORGate extends LogicGate {
    ...
    protected void drawComponent(Graphics2D g2) {
        ...
        int inputEndTop = (int) Math.round(getBackArcXAtY(backArcX, backArcWidth, topY, geo.bodyHeight, inputAY));
        int inputEndBottom = (int) Math.round(getBackArcXAtY(backArcX, backArcWidth, topY, geo.bodyHeight, inputBY));
