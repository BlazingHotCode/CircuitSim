 ...
 * EXTENSIBLE: Now implements ComponentInterface for maximum flexibility.
 */
public abstract class CircuitComponent implements PropertyOwner, ComponentInterface {
    ...
    /**
     * Updates the component size, clamping to the component's default size.
     */
    public void setSize(int width, int height) {
        this.width = Math.max(getMinimumWidth(), width);
    ...
    /**
     * Gets the index of a connection point, or -1 if not found.
     */
    public int getConnectionPointIndex(ConnectionPoint point) {
        return connectionPoints.indexOf(point);
    }
    ...
    // Implement ComponentInterface methods with default behavior
    @Override
    public void updateSimulation(java.util.List<Wire> wires) {
        // Default implementation - override in components that need simulation updates
    }
    
    @Override
    public int getNodeIndex(ConnectionPoint point) {
        return -1; // Default - override in components that need node tracking
    }
    
    @Override
    public void setNodeIndex(ConnectionPoint point, int index) {
        // Default implementation - override in components that need node tracking
    }
    
    @Override
    public int[] getAllNodeIndices() {
